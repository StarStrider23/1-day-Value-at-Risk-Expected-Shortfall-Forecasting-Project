...
For the multi-asset portfolio, dependencies between assets are explicitly modeled. Correlated asset returns are generated using Cholesky decomposition of the covariance matrix, ensuring that simulated paths preserve the empirical correlation structure between assets.
